...
loginRecover = {
    ...
    clickPasswordButton: function() {
        ...
        return this.elements.submitPassword().click();

    },
    clickUsernameSubmit: function() {


        return this.elements.submitUsername().click();
    ...
    enterEmail: function() {
        ...
        return this.elements.email().clear().sendKeys(validEmailAddress);

    },
    enterInvalidEmail: function() {

        return this.elements.email().sendKeys(invalidEmailAddress);
