...
exports.config = {
    ...
    capabilities: {
        ...
        'chromeOptions': {
            'args': [
                '--disable-extensions', '-–allow-file-access-from-files', '--disable-web-security', '--no-sandbox', '--test-type=browser'
            ],
            'prefs': {
                'download': {
    ...
    onPrepare: function( ) {
        ...
        var junitReporter = new reporters.JUnitXmlReporter({ savePath: './test/protractor', filePrefix: 'junit-', consolidateAll: false });
