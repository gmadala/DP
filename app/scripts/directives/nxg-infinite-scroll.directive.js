(function() {
  ...
  angular
    ...
    .directive('nxgInfiniteScroll', nxgInfiniteScroll);

  nxgInfiniteScroll.$inject = ['$rootScope', '$timeout', '$window', 'status'];

  function nxgInfiniteScroll($rootScope, $timeout, $window, status) {
