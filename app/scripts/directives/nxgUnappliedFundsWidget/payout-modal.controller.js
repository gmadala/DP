(function() {
  ...
  PayoutModalCtrl.$inject = ['$scope', 'dialog', 'funds', 'User', 'Payments', 'OptionDefaultHelper'];

  function PayoutModalCtrl($scope, dialog, funds, User, Payments, OptionDefaultHelper) {
    $scope.funds = funds;
    $scope.selections = {
      amount: null,
      account: null
