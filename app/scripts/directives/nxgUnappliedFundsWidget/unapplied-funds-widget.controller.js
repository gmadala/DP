(function() {
  ...
  UnappliedFundsWidgetCtrl.$inject = ['$scope', '$dialog', '$filter', 'api', 'gettextCatalog', 'AccountManagement'];

  function UnappliedFundsWidgetCtrl($scope, $dialog, $filter, api, gettextCatalog, AccountManagement) {
