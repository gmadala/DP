(function() {
  ...
  PaymentSummaryCtrl.$inject = ['$scope', '$state', 'Payments', 'PaymentOptions', 'gettext', 'User', 'gettextCatalog'];

  function PaymentSummaryCtrl($scope, $state, Payments, PaymentOptions, gettext, User, gettextCatalog) {
