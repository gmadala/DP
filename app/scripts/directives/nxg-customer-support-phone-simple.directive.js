...
// AngularJS working)
  angular
    ...
    .directive('nxgCustomerSupportPhoneSimple', nxgCustomerSupportPhoneSimple);

  nxgCustomerSupportPhoneSimple.$inject = ['customerSupportPhone'];

  function nxgCustomerSupportPhoneSimple(customerSupportPhone) {
