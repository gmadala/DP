...
describe('Directive: nxgBusinessField', function () {
  ...
  beforeEach(module('client/directives/nxg-business-field/nxg-business-field.html'));

  var element,
    scope;

  beforeEach(inject(function ($rootScope, $compile, $httpBackend) {
    $httpBackend.whenGET('client/directives/nxg-icon/nxg-icon.html').respond('<div></div>')
