(function() {
  ...
  function nxgPaymentButtons(gettextCatalog) {
    ...
    return {
      ...
      controller: function($scope, $uibModal, Payments, PaymentOptions) {
        ...
        $scope.cancelScheduledPayment = function () {
          var dialogOptions = {
            ...
            keyboard: true,
            backdropClick: true,
            templateUrl: 'client/modals/cancel-payment/cancel-payment.html',
        ...
        $scope.cancelScheduledFee = function () {
          var dialogOptions = {
            ...
            keyboard: true,
            backdropClick: true,
            templateUrl: 'client/modals/cancel-fee/cancel-fee.html',
      ...
      templateUrl: 'client/directives/nxg-payment-buttons/nxg-payment-buttons.html',
      replace: true
    };
