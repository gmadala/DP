(function() {
  ...
  PaymentDetailsCtrl.$inject = ['$scope', '$uibModalInstance', 'activity', 'gettext', 'gettextCatalog'];

  function PaymentDetailsCtrl($scope, $uibModalInstance, activity, gettext, gettextCatalog) {
