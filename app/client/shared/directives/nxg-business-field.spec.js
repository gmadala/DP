...
describe('Directive: nxgBusinessField', function () {
  ...
  beforeEach(module('client/shared/directives/nxg-business-field/nxg-business-field.html'));

  var element,
    scope;

  beforeEach(inject(function ($rootScope, $compile, $httpBackend) {
    $httpBackend.whenGET('client/shared/directives/nxg-icon/nxg-icon.html').respond('<div></div>')
