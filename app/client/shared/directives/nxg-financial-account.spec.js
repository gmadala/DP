...
describe('Directive: nxgFinancialAccount', function () {
  beforeEach(module('nextgearWebApp', 'client/shared/directives/nxg-financial-account/nxg-financial-account.html',
    'client/shared/directives/nxg-icon/nxg-icon.html'));
