describe('Directive: nxgCreditAvailability', function() {
  ...
  it('should display total available lines of credit', function() {
    ...
    expect(directiveScope.creditLimit).toEqual(numeral(10000000 + 99999999).format('($0.0a)').toUpperCase());
  });
  ...
  it('should display total available lines of credit', function() {
    ...
    expect(directiveScope.creditLimit).toEqual(numeral(10000000).format('($0.0a)').toUpperCase());
    ...
    expect(directiveScope.creditLimit).toEqual(numeral(99999999).format('($0.0a)').toUpperCase());
  });
});