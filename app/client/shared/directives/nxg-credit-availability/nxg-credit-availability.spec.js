describe('Directive: nxgCreditAvailability', function() {
  beforeEach(module('nextgearWebApp', 'client/shared/directives/nxg-credit-availability/nxg-credit-availability.template.html'));
  ...
  it('should display total available lines of credit', function() {
    ...
    expect(directiveScope.creditLimit).toEqual(numeral(10000000 + 99999999).format('($0.00a)').toUpperCase());
  });
  ...
  it('should display total available lines of credit', function() {
    ...
    expect(directiveScope.creditLimit).toEqual(numeral(10000000).format('($0.00a)').toUpperCase());
    ...
    expect(directiveScope.creditLimit).toEqual(numeral(99999999).format('($0.00a)').toUpperCase());
  });
});