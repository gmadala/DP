(function() {
  ...
  angular
    ...
    .directive('nxgBusinessFieldV2', nxgBusinessFieldV2);

  nxgBusinessFieldV2.$inject = [];

  function nxgBusinessFieldV2() {

    return {
      restrict: 'A',
      templateUrl: 'client/floor-vehicle/nxg-business-field-v2/nxg-business-field.template.html',
      replace: true,
      scope: {
        inputId: '@id',
        mode: '@nxgBusinessFieldV2',
        disabled: '=ngDisabled',
