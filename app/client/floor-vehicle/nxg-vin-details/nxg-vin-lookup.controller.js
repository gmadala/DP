(function() {
  ...
  angular
    ...
    .controller('VinLookupCtrl', VinLookupCtrl);

  VinLookupCtrl.$inject = ['$scope', 'moment', '$uibModal', '$q', 'Blackbook', 'User', 'VinValidator'];

  function VinLookupCtrl($scope, moment, $uibModal, $q, Blackbook, User, VinValidator) {
