    ...
    return {
      create: function (data) {
        ...
        angular.extend(data, {
          ...
          TitleLocationId: data.TitleLocationIndex ? data.TitleLocation.ResultingTitleLocationId : null,
          TitleTypeId: data.TitleLocation ? data.TitleLocation.ResultingTitleTypeId : null,
