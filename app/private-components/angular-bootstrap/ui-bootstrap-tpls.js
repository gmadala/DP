/**
 * ui.bootstrap version 0.5.0.
 * Modified by Josh Kramer at EffectiveUI.
 * Replaced typeahead section with 0.6.0 typeahead code.
 * This file should be deleted once Nextgear upgrades to
 * 0.6.0 or greater.
 *
 * Be sure to check all other files that were modified with the same commit as this
 * file was created when switching back to the bower version:
 *      karma.conf.js
 *      app/index.html
 *      bower.json
 */
