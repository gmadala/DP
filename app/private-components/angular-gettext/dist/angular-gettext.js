...
angular.module('gettext')
    ...
    .directive('translate', ["gettextCatalog", "$parse", "$compile", function (gettextCatalog, $parse, $compile) {
                ...
                return {
                    post: function (scope, element, attrs) {
                        ...
                        function update() {
                            ...
                            angular.element(element).append(newContents);
                            angular.element(oldContents).remove();
                        }
