...
var LoginPageObject = require('../ProtractorTest/login_page_object.js');
var CredentialsObject = require('../ProtractorTest/crentials_page_object.js');
var RecoverPageObject = require('../ProtractorTest/recover_page_object.js');
var HomePageObject = require('../ProtractorTest/home_page_object.js');
var UtilObject = require('../ProtractorTest/util_object.js');
...
//Login Page
describe ("Dealer Portal LoginPage", function() {     
    ...
    it("should not log you in if username and password are blank", function(){
       loginPage.doLogin('','');
       loginPage.goToLogin();
       expect($(('[ng-show="validity.credUsername.$error.required"]') && ('[ng-show="validity.credPassword.$error.required"]')).isDisplayed()).toBeTruthy(); 
...
describe ("Dealer Portal RecoveryPage", function() { 
