...
var RecoverPageObject = function(){
	...
	RecoverPageObject.prototype = Object.create({},{
		...
		recoverUrl:{ value: "http://localhost:9000/#/login/recover"
    	},

		// Locators
		recoveremailaddress: { get: function(){
